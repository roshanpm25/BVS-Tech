...
function Questionscomponent({ props, index }) {
  ...
  const [multipleOptions, setMultipleOptions] = useState(["Option 1"]);
  const [checkboxOptions, setCheckboxOptions] = useState(["Option 1"]);
  const [isFileDisabled, setIsFileDisabled] = useState(true);
  ...
  return (
    <div className="Questiontemplate">
      ...
      <div className="answers">
        {selectedOption.value === 'short_answer' && (
          <div className="short-answer-container">
            <input type="text" placeholder="Short answer text" className="answer1" disabled />
          </div>
        )}

        {selectedOption.value === 'paragraph' && (
          <div className="paragraph-container">
            <textarea placeholder="Long answer text" className="answer2" disabled></textarea>
          </div>
          ...
          <div className="multiple-choice-container">
            {multipleOptions.map((option, idx) => (
              <div key={idx} className="option-row">
                ...
                />
                <div className="delete-option-btn">
                  <button type="button" onClick={() => removeOption(idx)} disabled={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#666666">
                      <path d="M200-440v-80h560v80H200Z" />
                    </svg>
                  </button>
            ...
            <button type="button" className="add-option-btn" onClick={addOption} disabled={false}>
              + Add Option
            </button>
          </div>
        )}
          ...
          <div className="checkbox-container">
            {checkboxOptions.map((cb_option, idx) => (
              <div key={idx} className="cb-option-row">
                ...
                />
                <div className="delete-option-btn">
                  <button type="button" onClick={() => checkbox_removeOption(idx)} disabled={false}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#666666">
                      <path d="M200-440v-80h560v80H200Z" />
                    </svg>
                  </button>
            ...
            <button type="button" className="add-option-btn-1" onClick={checkbox_addOption} disabled={false}>
              + Add Option
            </button>
          </div>
        )}
